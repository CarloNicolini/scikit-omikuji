...
def test_run_eurlex4k(train_file):
    ...
    label_score_pairs = model.predict(feature_value_pairs, top_k=6)
    ...
    # else:
    #     if pid == 0:
    #         label_score_pairs = model.predict(feature_value_pairs, top_k=5)
